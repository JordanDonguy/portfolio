...
export default function AnimatedHeroText({ handleFormButton }: AnimatedHeroTextProps) {
  ...
  return (
    <SlideFromRight>
        <div className="relative duration-200 mt-16 max-h-[700px] h-full md:h-fit px-2">
          <h1 className="text-4xl md:text-4xl/16 xl:text-5xl/20 text-white font-bold pb-10 animate-grow-subtle mx-4 md:mx-0">
            {t.rich("greeting", {
          ...
          <p className="text-xl md:text-xl/10 xl:text-2xl/12 max-w-xl xl:max-w-3xl pb-10">{t("presentation")}</p>
          <div className="w-full lg:w-xl flex flex-col md:flex-row justify-between items-center duration-500 gap-8 md:gap-16">
            <button
