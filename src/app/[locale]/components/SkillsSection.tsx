...
export default function SkillsSection() {
  ...
  const backEndList = ["NodedotJs", "ExpressdotJs", "PostgreSQL", "Prisma", "Sequelize",];
  const toolsList = ["Git", "GitHub", "Jest", "GH Actions", "ESLint", "JWT", "Cloudflare", "Vercel", "Supabase", "Neon"]
            ...
            <section className="max-w-6xl mx-auto mb-4 flex flex-col items-center pb-4">
              ...
              <div className="flex justify-center items-center gap-x-8 gap-y-4 flex-wrap mb-2 md:mb-0">
                {languagesList.map(item =>
                  <article key={item} className="flex flex-col items-center justify-evenly w-28 h-28 bg-zinc-800 rounded-xl">
