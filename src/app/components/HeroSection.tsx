...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="relative w-full overflow-hidden mx-auto h-screen flex flex-col items-center text-center justify-center">
        ...
        <div className={`${showForm ? "scale-100" : "scale-0"} duration-200 absolute z-10 max-w-5xl w-full h-full pt-16 md:pt-0 md:h-3/4`}>
      ...
      <div className={`${!showForm ? "lg:bg-[rgba(11,11,14,0.5)] lg:backdrop-blur-sm lg:border-y border-zinc-700" : ""} mt-16 py-12 px-8 rounded-asym flex flex-col items-center w-full lg:w-6xl`}>
